...
namespace New_SSQE.NewGUI.Windows
{
    internal class GuiWindowKeybinds : GuiWindow
    {
        ...
        public static readonly GuiCheckbox CtrlIndicator = new(64, 828, 64, 64, null, "CTRL Held", 36) { Style = new(ControlStyles.Checkbox_Uncolored) };
        public static readonly GuiCheckbox AltIndicator = new(64, 912, 64, 64, null, "ALT Held", 36) { Style = new(ControlStyles.Checkbox_Uncolored) };
        public static readonly GuiCheckbox ShiftIndicator = new(64, 996, 64, 64, null, "SHIFT Held", 36) { Style = new(ControlStyles.Checkbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind HFlipBox = new(1366, 130, 128, 40, Settings.hFlip, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind VFlipBox = new(1366, 210, 128, 40, Settings.vFlip, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind StoreNodesBox = new(1366, 290, 128, 40, Settings.storeNodes, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind AnchorNodeBox = new(1366, 370, 128, 40, Settings.anchorNode, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind DrawBezierBox = new(1366, 450, 128, 40, Settings.drawBezier, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind SwitchClickBox = new(150, 130, 128, 40, Settings.switchClickTool, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind ToggleQuantumBox = new(150, 210, 128, 40, Settings.quantum, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind OpenTimingsBox = new(150, 330, 128, 40, Settings.openTimings, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind OpenBookmarksBox = new(150, 410, 128, 40, Settings.openBookmarks, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind OpenDirectoryBox = new(150, 490, 128, 40, Settings.openDirectory, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxKeybind ExportSSPMBox = new(150, 570, 128, 40, Settings.exportSSPM, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        ...
        public static readonly GuiTextboxGridKeybind Grid0Box = new(778, 75, 128, 40, 0, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid0Reset = new(778, 119, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid1Box = new(916, 75, 128, 40, 1, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid1Reset = new(916, 119, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid2Box = new(1054, 75, 128, 40, 2, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid2Reset = new(1054, 119, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid3Box = new(778, 169, 128, 40, 3, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid3Reset = new(778, 213, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid4Box = new(916, 169, 128, 40, 4, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid4Reset = new(916, 213, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid5Box = new(1054, 169, 128, 40, 5, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid5Reset = new(1054, 213, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid6Box = new(778, 263, 128, 40, 6, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid6Reset = new(778, 307, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid7Box = new(916, 263, 128, 40, 7, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
        public static readonly GuiButton Grid7Reset = new(916, 307, 128, 40, "RESET", 36);
        public static readonly GuiTextboxGridKeybind Grid8Box = new(1054, 263, 128, 40, 8, "", 28) { Style = new(ControlStyles.Textbox_Uncolored) };
