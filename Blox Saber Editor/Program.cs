        ...
        static Program()
        {
            ...
            catch (Exception ex)
            {
                var lines = new string[]
                {
                    ...
                    "If none of these work or this error was thrown while the editor was already running, report the bug in the official Sound Space Discord server or contact Avibah#6449 to attempt to resolve the issue if possible."
                };
