        ...
        static Program()
        {
            ...
            catch (Exception ex)
            {
                var lines = new string[]
                {
                    ...
                    "If none of these work or this error was thrown while the editor was already running, contact Avibah#6449 on Discord to attempt to resolve the issue if possible."
                };
